...
public class ScrollLayout extends ViewGroup {
    ...
    private OnScrollLayoutListener onScrollLayoutListener = null;
    ...
    public void setOnScrollLayoutListener(
    ...
    public void snapToScreen(int whichScreen) {
        ...
        if (onScrollLayoutListener != null) {
            onScrollLayoutListener.onSnapWhich(mCurScreen);
        }
    }
     ...
     * TODO: 回调当前需要切换至的显示屏幕子控件接口
     */
    public interface OnScrollLayoutListener {
        void onSnapWhich(int position);
    }
}
