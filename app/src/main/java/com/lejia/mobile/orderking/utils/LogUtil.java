...
public class LogUtil {
    ...
    public static final boolean alow=true;
...
//    public static boolean allowWtf = false;
    public static boolean allowD = alow;
    public static boolean allowE = alow;
    public static boolean allowI = alow;
    public static boolean allowV = alow;
    public static boolean allowW = alow;
    public static boolean allowWtf = alow;
